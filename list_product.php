...
$query = "SELECT * FROM Products WHERE status = 1 AND is_accept = 1 ORDER BY CountView DESC LIMIT $start, $itemsPerPage";
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="shop__pagination">
                ...
                <?php } ?>
                <a href="?page=<?php echo min($totalPages, $page + 1); ?>"><span class="arrow_carrot-right"></span></a>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
